            ...
            <div className='flex flex-col bg-white w-full mx-6 mt-4 mb-6 md:mx-12 rounded-lg '>
                <Tab.Group>
                    <Tab.List className='flex flex-row w-auto  h-12 space-x-[1px]'>
                        <Tab className='flex flex-row bg-text-color4 hover:bg-text-color1  hover:text-white rounded rounded-left-lg md:rounded-left-0 items-center  p-5 space-x-4'>
                    ...
                    <Tab.Panels>
                        ...
                        <Tab.Panel className='md:my-6 md:mx-4 md:pb-80 lg:pb-80' >
                            < div className='grid grid-cols-1 md:col-span-1  md:grid-cols-2   md:space-y-6 px-4'>
                                ...
                                <div className='flex flex-row bg-text-color1   text-[16px] text-center px-16 justify-between rounded-lg py-2 text-white'>Add payement method
                                ...
                                <div className='flex  flex-col items-center'>
                                    ...
                                    <div className='flex flex-row items-center justify-center space-x-4'>
                                        ...
                                        <div className='flex flex-col items-center bg-text-color4  border border-slate-500 py-4 rounded-lg justify-center mx-2 '>
                                            ...
                                            <div className=' text-text-color1 text-center mx-6 font-semibold '>Message</div>

                                        </div>
                                        <div className='flex flex-col items-center bg-text-color4  border border-slate-500 py-4 rounded-lg justify-center mx-2 '>
                                            <img src={messenger} className='w-12 h-12 rounded-full' alt="" />
                                            <div className=' text-text-color1 text-center  mx-4 font-semibold '>Messenger</div>
